...
echo "Checking ICMP redirect acceptance..."

FAIL=0

for param in net.ipv4.conf.all.accept_redirects \
             net.ipv4.conf.default.accept_redirects; do
...
for param in net.ipv6.conf.all.accept_redirects \
